...
export default function BlocksRendererClient({ content }: Props) {
  ...
  return (
    <BlocksRenderer
      ...
      blocks={{
        paragraph: ({ children }) => (
          <p className='prose prose-stone max-w-prose lg:prose-lg'>
            {children}
          </p>
        ),
        list: ({ children, format }) => {
          if (format === 'ordered') {
            return (
              <ol className='prose prose-stone max-w-prose list-inside list-decimal lg:prose-lg'>
                {children}
              </ol>
            );
          } else {
            return (
              <ul className='prose prose-stone max-w-prose list-inside list-disc lg:prose-lg'>
                {children}
              </ul>
            );
          }
